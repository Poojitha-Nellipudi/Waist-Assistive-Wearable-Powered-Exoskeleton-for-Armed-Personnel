...
v_e = 2.5;
xend = 0; % to convert w.r.t reference frame
...
video = VideoWriter('biped_loop.avi');
open(video);
...
for n = 1:5
    ...
    plot([plotx0(j)+xend,plotx2(j)+xend],[plotz0(j),plotz2(j)],'r-o','linewidth',3,'MarkerEdgeColor','k',...
                        'MarkerFaceColor','k',...
                        'MarkerSize',5)
    hold on
    plot([plotx0(j)+xend,plotx0(j)+5+xend],[plotz0(j),plotz0(j)],'r-o','linewidth',3,'MarkerEdgeColor','k',...
                        'MarkerFaceColor','k',...
                        'MarkerSize',5)
    plot([plotx2(j)+xend,plotx4(j)+xend],[plotz2(j),plotz4(j)],'b-o','linewidth',3,'MarkerEdgeColor','k',...
                        'MarkerFaceColor','k',...
                        'MarkerSize',5)

    plot([plotx4(j)+xend,plotx5(j)+xend],[plotz4(j),plotz5(j)],'m-o','linewidth',3,'MarkerEdgeColor','k',...
                        'MarkerFaceColor','k',...
                        'MarkerSize',5)

    plot([plotxw0(j)+xend,plotxw2(j)+xend],[plotzw0(j),plotzw2(j)],'g-o','linewidth',3,'MarkerEdgeColor','k',...
                        'MarkerFaceColor','k',...
                        'MarkerSize',5)
    plot([plotxw2(j)+xend,plotxw4(j)+xend],[plotzw2(j),plotzw4(j)],'k-o','linewidth',3,'MarkerEdgeColor','k',...
                        'MarkerFaceColor','k',...
                        'MarkerSize',5)
    plot([plotxw4(j)+xend,plotxw4(j)+5+xend],[plotzw4(j),plotzw4(j)],'k-o','linewidth',3,'MarkerEdgeColor','k',...
                        'MarkerFaceColor','k',...
                        'MarkerSize',5)
    ...
    plot([plotx0(j)+xend,plotx2(j)+xend],[plotz0(j),plotz2(j)],'k-o','linewidth',3,'MarkerEdgeColor','k',...
                        'MarkerFaceColor','k',...
                        'MarkerSize',5)
    hold on
    plot([plotx0(j)+xend,plotx0(j)+5+xend],[plotz0(j),plotz0(j)],'k-o','linewidth',3,'MarkerEdgeColor','k',...
                        'MarkerFaceColor','k',...
                        'MarkerSize',5)
    plot([plotx2(j)+xend,plotx4(j)+xend],[plotz2(j),plotz4(j)],'g-o','linewidth',3,'MarkerEdgeColor','k',...
                        'MarkerFaceColor','k',...
                        'MarkerSize',5)
    ...
    plot([plotxw0(j)+xend,plotxw2(j)+xend],[plotzw0(j),plotzw2(j)],'b-o','linewidth',3,'MarkerEdgeColor','k',...
                        'MarkerFaceColor','k',...
                        'MarkerSize',5)
    plot([plotxw2(j)+xend,plotxw4(j)+xend],[plotzw2(j),plotzw4(j)],'r-o','linewidth',3,'MarkerEdgeColor','k',...
                        'MarkerFaceColor','k',...
                        'MarkerSize',5)
    plot([plotxw4(j)+xend,plotxw4(j)+5+xend],[plotzw4(j),plotzw4(j)],'r-o','linewidth',3,'MarkerEdgeColor','k',...
                        'MarkerFaceColor','k',...
                        'MarkerSize',5)
